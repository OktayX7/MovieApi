        ...
        <div className="row justify-content-center">
          <div className="col-auto">
            ...
            <nav className="list-unstyled list-inline text-center">
              ...
              <li className="list-inline-item">
                <Link href="https://instagram.com" target="_blank" className="fs-3">
                  <FontAwesomeIcon icon={faInstagram} />
                </Link>
              </li>
              <li className="list-inline-item">
                <Link href="https://facebook.com" target="_blank" className="fs-3">
                  <FontAwesomeIcon icon={faFacebook} />
                </Link>
              </li>
              <li className="list-inline-item">
                <Link href="https://youtube.com" target="_blank" className="fs-3">
